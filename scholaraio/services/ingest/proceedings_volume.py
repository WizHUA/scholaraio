...
from scholaraio.services.ingest_metadata import _clean_title_for_filename, _sanitize_for_filename
...
def ingest_proceedings_markdown(
    ...
    *,
    ...
    """Write a proceedings volume shell under the configured proceedings root and wait for split review."""
